...
if __name__ == "__main__":
    ...
    for i, dataset_type in enumerate(dataset_types):
        for j, model_class in enumerate(models):
            ...
            Utils.combined_pr_auc_compare_models(models, list(dict_data_models[dataset_type].values()), test_dl, dataset_type, file_name=f"{Utils.PREFIX_ROC}_combined_{dataset_type}_{run_no}")
